...
public class Home_Calendar_counselor : MonoBehaviour
{
    ...
    public static Home_Calendar_counselor _calendarInstance;
    ...
    void Start()
    {
        ...
        for (int i = 1; i < _totalDateNum; i++)
        {
            ...
            item.transform.localPosition = new Vector3((i % 7) * 86 + startPos.x, startPos.y - (i / 7) * 60, startPos.z);
    ...
    void CreateCalendar()
    {
        ...
        //_todayText.transform.position = new Vector3(320, 230, 0);
